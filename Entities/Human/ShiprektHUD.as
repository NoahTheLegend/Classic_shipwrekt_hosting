...
const SColor shareColor = SColor(255, 255, 0, 255);
...
void onRender(CSprite@ this)
{
	...
	else
	{
		...
		if (WARMUP_TIME > 0)
		{
			...
			GUI::DrawText("You can share money between team or to your captain! Click on the coin icon below!", Vec2f(screenWidth/2 - 220, 30), shareColor);
		}
	}
